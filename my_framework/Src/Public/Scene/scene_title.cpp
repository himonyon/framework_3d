...
void SceneTitle::Execute() {
	...
	Font::Print(L"testesÇ»Ç»Ç»twstsseÅ@%d ", Input::JoyPovOn(18000));
	Font::SetColor(0xff88ff88);
	Font::Print(200, 130, L"vvvÅ@%d ", Input::JoyPovOn(18000));
	Font::Print(200, 160, L"vvvÅ@%d ", Input::JoyPovOn(18000));
	Font::SetRect();
